...
- Run ID: int01a-2026-07-01T12-05-43-309Z-827e2ea9
- Status: **FAIL**
- Started: 2026-07-01T12:05:43.310Z
- Ended: 2026-07-01T12:05:44.221Z
...
| INT01A-01 | PASS | 49 | Database connectivity uses real PostgreSQL |
...
| INT01A-05 | FAIL | 714 | Post Sales / Delivery baseline through approved surface |
  ...
  "errors": [
    {
      ...
      "message": "this.accountSettingsRepository.findBySubtype is not a function"
    }
  ]
}
```
...
{
  "runner": "INT-01A_P0_v1.0",
  "runId": "int01a-2026-07-01T12-05-43-309Z-827e2ea9",
  "status": "FAIL",
  "startedAt": "2026-07-01T12:05:43.310Z",
  "endedAt": "2026-07-01T12:05:44.221Z",
  "environment": {
  ...
  "steps": [
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T12:05:43.310Z",
      "endedAt": "2026-07-01T12:05:43.311Z",
      "durationMs": 1,
      "evidence": {
        "requiredEnv": [
          "DATABASE_URL",
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T12:05:43.311Z",
      "endedAt": "2026-07-01T12:05:43.360Z",
      "durationMs": 49,
      "evidence": {
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T12:05:43.360Z",
      "endedAt": "2026-07-01T12:05:43.400Z",
      "durationMs": 40,
      "evidence": {
        "migrationInfo": {
          "migrationTable": null,
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T12:05:43.400Z",
      "endedAt": "2026-07-01T12:05:43.439Z",
      "durationMs": 39,
      "evidence": {
        "companyId": "b9acc1ea-84e2-4a10-b2a4-07928be4a4a1",
        "companyExists": true,
        "masterData": {
          "customers": {
            "count": 1,
        ...
        "accountChecks": {
          "inventory": {
            "id": "8346be95-19be-4dd5-96a4-40261768f615",
            "exists": true
          },
          "cogs": {
            "id": "74dfc15d-5ea0-47e2-b890-5a63f9c34246",
            "exists": true
          },
          "revenue": {
            "id": "835c54db-b3c2-4b7c-9b4c-f9878d5184a9",
            "exists": true
          },
          "expense": {
            "id": "a567baf3-0bb8-4df5-9c63-76e525d30d06",
            "exists": true
          },
          "grni": {
            "id": "1325092e-b9f8-42f7-be31-3bcfe9c2aad9",
            "exists": true
          }
        },
        "grniSubtype": {
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T12:05:43.439Z",
      "endedAt": "2026-07-01T12:05:43.444Z",
      "durationMs": 5,
      "evidence": {
        "mode": "module",
    ...
    },
    {
      ...
      "status": "FAIL",
      "startedAt": "2026-07-01T12:05:43.506Z",
      "endedAt": "2026-07-01T12:05:44.220Z",
      "durationMs": 714,
      "evidence": null,
      "error": {
