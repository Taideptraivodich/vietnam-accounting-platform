...
- Run ID: int01a-2026-07-01T12-54-26-154Z-399c0bac
- Status: **FAIL**
- Started: 2026-07-01T12:54:26.155Z
- Ended: 2026-07-01T12:54:26.591Z
...
| INT01A-02 | PASS | 40 | Migrations already applied / freeze-scope tables exist |
...
| INT01A-05 | FAIL | 237 | Post Sales / Delivery baseline through approved surface |
  ...
  "errors": [
    {
      ...
      "message": "[INT01B] AR/AP ledger dependency failed while creating sales outstanding"
    }
  ]
}
```
...
{
  "runner": "INT-01A_P0_v1.0",
  "runId": "int01a-2026-07-01T12-54-26-154Z-399c0bac",
  "status": "FAIL",
  "startedAt": "2026-07-01T12:54:26.155Z",
  "endedAt": "2026-07-01T12:54:26.591Z",
  "environment": {
  ...
  "steps": [
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T12:54:26.155Z",
      "endedAt": "2026-07-01T12:54:26.156Z",
      "durationMs": 1,
      "evidence": {
        "requiredEnv": [
          "DATABASE_URL",
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T12:54:26.156Z",
      "endedAt": "2026-07-01T12:54:26.208Z",
      "durationMs": 52,
      "evidence": {
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T12:54:26.208Z",
      "endedAt": "2026-07-01T12:54:26.248Z",
      "durationMs": 40,
      "evidence": {
        "migrationInfo": {
          "migrationTable": null,
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T12:54:26.248Z",
      "endedAt": "2026-07-01T12:54:26.288Z",
      "durationMs": 40,
      "evidence": {
        "companyId": "650d9d75-35b0-4bfc-93c2-9422d71d30cc",
        "companyExists": true,
        "masterData": {
          "customers": {
            "count": 1,
        ...
        "accountChecks": {
          "inventory": {
            "id": "a2d81ecd-fa1b-4f2c-b933-57baa54d6d0f",
            "exists": true
          },
          "cogs": {
            "id": "a4ec5356-743c-4c5f-a2f3-df39bc8960b6",
            "exists": true
          },
          "revenue": {
            "id": "5e4830d0-82f2-4f83-adc0-2c0fc52dd97d",
            "exists": true
          },
          "expense": {
            "id": "935115a7-96ed-4012-ae62-851f2213dec7",
            "exists": true
          },
          "grni": {
            "id": "56d52558-fb1b-49a3-9f28-54ad956ef20e",
            "exists": true
          }
        },
        "grniSubtype": {
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T12:54:26.288Z",
      "endedAt": "2026-07-01T12:54:26.296Z",
      "durationMs": 8,
      "evidence": {
        "mode": "module",
    ...
    },
    {
      ...
      "status": "FAIL",
      "startedAt": "2026-07-01T12:54:26.353Z",
      "endedAt": "2026-07-01T12:54:26.590Z",
      "durationMs": 237,
      "evidence": null,
      "error": {
