...
- Run ID: int01a-2026-07-01T14-32-03-115Z-2584bf05
- Status: **FAIL**
- Started: 2026-07-01T14:32:03.116Z
- Ended: 2026-07-01T14:32:03.515Z
...
| INT01A-02 | PASS | 58 | Migrations already applied / freeze-scope tables exist |
| INT01A-03 | PASS | 46 | MD-01 seed/preseed real master data exists |
| INT01A-04 | PASS | 11 | Approved module surface adapter/commands are bound |
| INT01A-05 | FAIL | 167 | Post Sales / Delivery baseline through approved surface |
...
{
  "runner": "INT-01A_P0_v1.0",
  "runId": "int01a-2026-07-01T14-32-03-115Z-2584bf05",
  "status": "FAIL",
  "startedAt": "2026-07-01T14:32:03.116Z",
  "endedAt": "2026-07-01T14:32:03.515Z",
  "environment": {
  ...
  "steps": [
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T14:32:03.116Z",
      "endedAt": "2026-07-01T14:32:03.117Z",
      "durationMs": 1,
      "evidence": {
        "requiredEnv": [
          "DATABASE_URL",
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T14:32:03.117Z",
      "endedAt": "2026-07-01T14:32:03.170Z",
      "durationMs": 53,
      "evidence": {
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T14:32:03.170Z",
      "endedAt": "2026-07-01T14:32:03.228Z",
      "durationMs": 58,
      "evidence": {
        "migrationInfo": {
          "migrationTable": null,
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T14:32:03.228Z",
      "endedAt": "2026-07-01T14:32:03.274Z",
      "durationMs": 46,
      "evidence": {
        "companyId": "4f7e14a4-edcc-4d3a-82d8-c64435610543",
        "companyExists": true,
        "masterData": {
          "customers": {
            "count": 1,
        ...
        "accountChecks": {
          "inventory": {
            "id": "cfe6ae4c-ab1d-4011-8299-2d09dca505a3",
            "exists": true
          },
          "cogs": {
            "id": "64e942ba-424c-4201-92e7-7612793a9fd7",
            "exists": true
          },
          "revenue": {
            "id": "f609f051-3b05-44de-818f-0b303360c7f7",
            "exists": true
          },
          "expense": {
            "id": "74a49a19-c40f-4595-a073-2b812dee11f5",
            "exists": true
          },
          "grni": {
            "id": "86e5ca65-3477-49ee-9f92-ac991481be87",
            "exists": true
          }
        },
        "grniSubtype": {
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T14:32:03.274Z",
      "endedAt": "2026-07-01T14:32:03.285Z",
      "durationMs": 11,
      "evidence": {
        "mode": "module",
    ...
    },
    {
      ...
      "status": "FAIL",
      "startedAt": "2026-07-01T14:32:03.347Z",
      "endedAt": "2026-07-01T14:32:03.514Z",
      "durationMs": 167,
      "evidence": null,
      "error": {
        "name": "TypeError",
