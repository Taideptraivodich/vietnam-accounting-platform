...
- Run ID: int01a-2026-07-01T11-57-31-867Z-d8500515
- Status: **FAIL**
- Started: 2026-07-01T11:57:31.869Z
- Ended: 2026-07-01T11:57:32.146Z
...
- Error: invalid input syntax for type uuid: "INT01D-EW05-1782907052130"
...
{
  "runner": "INT-01A_P0_v1.0",
  "runId": "int01a-2026-07-01T11-57-31-867Z-d8500515",
  "status": "FAIL",
  "startedAt": "2026-07-01T11:57:31.869Z",
  "endedAt": "2026-07-01T11:57:32.146Z",
  "environment": {
  ...
  "steps": [
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T11:57:31.869Z",
      "endedAt": "2026-07-01T11:57:31.870Z",
      "durationMs": 1,
      "evidence": {
        "requiredEnv": [
          "DATABASE_URL",
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T11:57:31.870Z",
      "endedAt": "2026-07-01T11:57:31.923Z",
      "durationMs": 53,
      "evidence": {
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T11:57:31.923Z",
      "endedAt": "2026-07-01T11:57:31.963Z",
      "durationMs": 41,
      "evidence": {
        "migrationInfo": {
          "migrationTable": null,
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T11:57:31.964Z",
      "endedAt": "2026-07-01T11:57:32.004Z",
      "durationMs": 40,
      "evidence": {
        "companyId": "08d657ec-dfe2-46f5-9d39-bb32054505cd",
        "companyExists": true,
        "masterData": {
          "customers": {
            "count": 1,
        ...
        "accountChecks": {
          "inventory": {
            "id": "19ceb66a-f260-4a60-acf3-7430d349069a",
            "exists": true
          },
          "cogs": {
            "id": "ec3627df-da85-48d5-8335-313622faf136",
            "exists": true
          },
          "revenue": {
            "id": "22bf49d1-f9ab-4a24-a180-ae0a485e143b",
            "exists": true
          },
          "expense": {
            "id": "f6bdc109-7664-44c7-96af-76267f6c93ba",
            "exists": true
          },
          "grni": {
            "id": "21235631-0f9e-4363-9a3f-4461c6873979",
            "exists": true
          }
        },
        "grniSubtype": {
    ...
    },
    {
      ...
      "status": "PASS",
      "startedAt": "2026-07-01T11:57:32.004Z",
      "endedAt": "2026-07-01T11:57:32.010Z",
      "durationMs": 6,
      "evidence": {
        "mode": "module",
    ...
    },
    {
      ...
      "status": "FAIL",
      "startedAt": "2026-07-01T11:57:32.068Z",
      "endedAt": "2026-07-01T11:57:32.145Z",
      "durationMs": 77,
      "evidence": null,
      "error": {
        "name": "error",
        "message": "invalid input syntax for type uuid: \"INT01D-EW05-1782907052130\""
      }
    }
  ],
  "openIssues": [
